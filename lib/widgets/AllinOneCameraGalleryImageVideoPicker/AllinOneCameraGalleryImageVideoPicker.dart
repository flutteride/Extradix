...
import 'package:thinkcreative_technologies/widgets/PhotoEditor/photoeditor.dart';
                        ...
                        children: [
                          Text(
                            controller != null &&
                                ...
                                ? controller!.value.isRecordingPaused
                                    ? ""
                                    : "${getTranslatedForCurrentUser(context, 'xxrecordingxx')}"
                                : getTranslatedForCurrentUser(
                                    context, 'xxlongpressforvideoxx'),
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 13,
                            ),
