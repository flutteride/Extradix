...
import 'package:thinkcreative_technologies/widgets/Passcode/circle.dart';
import 'package:thinkcreative_technologies/widgets/Passcode/keyboard.dart';
import 'package:thinkcreative_technologies/widgets/Passcode/shake_curve.dart';
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              widget.wait
                  ? getTranslatedForCurrentUser(context, 'hardguess')
                  : widget.title!,
                ...
                child: Keyboard(
                  ...
                  keyboardUIConfig: widget.keyboardUIConfig != null
                      ...
                      : KeyboardUIConfig(
                          ...
                          digitTextStyle:
                              TextStyle(fontSize: 30, color: Mycolors.black)),
                ),
              ),
            ),
            _isValid == true
                ? Container(
                    ...
                    child: Padding(
                        ...
                        child: myElevatedButton(
                          color: Colors.green,
                          child: Text(
                            getTranslatedForCurrentUser(this.context, 'done'),
            ...
            widget.authentication && forgetVisible
                ? Padding(
                    ...
                    child: Text(
                        getTranslatedForCurrentUser(context, 'trylater'),
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            fontSize: 14,
                            height: 1.4,
