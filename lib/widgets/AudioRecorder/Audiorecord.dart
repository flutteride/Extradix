...
import 'package:thinkcreative_technologies/widgets/AudioRecorder/playButton.dart';
...
class _AudioRecordState extends State<AudioRecord> {
  ...
  @override
  void initState() {
    _mPlayer!.closePlayer().then((value) {
      setStateIfMounted(() {
  ...
  Future<void> openTheRecorder() async {
    if (!kIsWeb) {
      ...
      if (status != PermissionStatus.granted) {
        Utils.showRationale(
            getTranslatedForCurrentUser(this.context, 'xxpmxx'));
                          ...
                          : ElevatedButton(
                              ...
                              onPressed: () {
                                ...
                                if (recordedfile!.lengthSync() / 1000000 >
                                  ...
                                  Utils.toast(
                                      '${getTranslatedForCurrentUser(this.context, 'xxmaxfilesizexx')} ${observer.maxFileSizeAllowedInMB}MB\n\n${getTranslatedForCurrentUser(this.context, 'xxselectedfilesizexx')} ${(recordedfile!.lengthSync() / 1000000).round()}MB');
                                } else {
                                  setStateIfMounted(() {
                                    isLoading = true;
                                  });
