...
import 'package:thinkcreative_technologies/widgets/OtherCustomWidgets/custom_dividers.dart';
import 'package:thinkcreative_technologies/widgets/OtherCustomWidgets/mycustomtext.dart';
import 'package:thinkcreative_technologies/widgets/OtherCustomWidgets/placeholder.dart';
    ...
    return Align(
      child: Container(
        margin: EdgeInsets.fromLTRB(
            widget.leftrightmargin ?? 0, 10, widget.leftrightmargin ?? 0, 10),
        ...
        child: Column(
          ...
          children: [
            widget.title == null
                ? SizedBox()
                : Padding(
                    padding: const EdgeInsets.fromLTRB(0, 0, 7, 6.5),
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                    ...
                    suffixIcon: widget.sufficIconbutton != null ||
                        ...
                        : null,
                    filled: true,
                    fillColor: widget.boxbcgcolor != null
                        ? widget.boxbcgcolor
                        : widget.disabled == true
                            ? Mycolors.greylightcolor
                            : Mycolors.textboxbgcolor.withOpacity(0.7),
                    enabledBorder: OutlineInputBorder(
                      // width: 0.0 produces a thin "hairline" border
                      borderRadius:
                          BorderRadius.circular(widget.boxcornerradius ?? 6),
                      borderSide: BorderSide(
                          color: widget.boxbordercolor ?? Mycolors.greylight,
                          width: 1.3),
                    ),
                    focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius:
                          BorderRadius.circular(widget.boxcornerradius ?? 6),
                      borderSide: BorderSide(
                          color: widget.focuscolor ?? Colors.green, width: 1.3),
                    ),
    ...
    if (await Permission.storage.request().isGranted) {
      ...
      showDialog(
          ...
          builder: (context) => AlertDialog(
                ...
                content: Text(
                    "Please Allow $Appname app to read & write Storage to pick particular file which you select.\n\n1.  Tap on OPEN APP SETTINGS  \n\n2.  Go to PERMISSIONS          \n\n3.  Allow / Turn On the Storage Switch."),
              ));
    }
  }
                        ...
                        children: <Widget>[
                          ...
                          widget.boxwidth! < 105
                              ...
                              : Text(
                                  ...
                                  style: TextStyle(
                                      color: Mycolors.greylight, fontSize: 12),
                                ),
                          widget.boxwidth! < 185
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color:
                                  widget.boxbordercolor ?? Mycolors.greylight,
                              style: BorderStyle.solid,
                              width: widget.boxborderwidth ?? 1.5),
                          borderRadius: BorderRadius.all(
                              Radius.circular(widget.boxcornerradius ?? 0))),
                    ...
                    ? Column(
                        ...
                        children: <Widget>[
                          ...
                          widget.boxwidth! < 105
                              ...
                              : Text(
                                  widget.placeholder == null
                                      ? '.PDF (Max. ${widget.maxsize ?? 50} MB)'
                                      : '${widget.placeholder} px (Max. ${widget.maxsize ?? 50} MB)',
                                  style: TextStyle(
                                      color: Mycolors.greylight, fontSize: 12),
                                ),
                          widget.boxwidth! < 185
