...
import 'package:thinkcreative_technologies/Services/helpers/size.dart';
import 'package:thinkcreative_technologies/Services/helpers/transition.dart';
import 'package:thinkcreative_technologies/Services/helpers/widgets/animated_interactive_viewer.dart';
import 'package:thinkcreative_technologies/Services/helpers/widgets/widgets.dart';
...
class _VideoEditorState extends State<VideoEditor> {
  ...
  Future<bool> onWillPop() {
    ...
    if (now.difference(currentBackPressTime!) > Duration(seconds: 3)) {
      ...
      Utils.toast('Double Tap To Close Editor');
