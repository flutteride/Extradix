...
Future<void> downloadFile(
  ...
  try {
      ...
      if (res) {
        ...
        if (fileExists == true) {
          ...
          await dio.download(
            ...
            Navigator.of(keyloader!.currentContext!, rootNavigator: true)
                .pop(); //
            Utils.toast(getTranslatedForCurrentUser(context, 'xxepsxx'));
          });
        }
      } else {
        Utils.showRationale(getTranslatedForCurrentUser(context, 'xxpsxx'));
    ...
    Utils.toast(
      getTranslatedForCurrentUser(context, 'xxalreadydeletedxx'),
    );
  }
}
